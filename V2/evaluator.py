...
from V2.preprocess import PreprocessingPipeline, LogSpectrogramExtractor, MinMaxNormaliser
from V2.sound_generator import SoundGenerator
from V2.unet import UNet
from V2.utilities import setup_device
...
def eval_model(model):
    ...
    preprocessing_pipeline.normaliser = MinMaxNormaliser(0, 1)
    ...
    noisy_feature = preprocessing_pipeline.extractor.extract(noisy_signal)[:, :-3]
